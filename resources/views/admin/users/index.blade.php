...
<div class="mb-4">
    <p class="text-sm text-gray-500">Cet onglet est dédié aux comptes <strong>locataires</strong>. Pour les propriétaires et agents immobiliers, voir l'onglet <a href="{{ route('admin.agents.index') }}" class="text-blue-600 hover:underline">Agents Immo</a>.</p>
</div>
...
<div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
    <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
        <h2 class="font-bold text-gray-900">Locataires ({{ $users->total() ?? 0 }})</h2>
