        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="https://wa.me/22510142004609" target="_blank" class="text-primary-200 hover:text-white text-sm transition-colors">WhatsApp : +225 01 01 42 00 46 09</a></li>
