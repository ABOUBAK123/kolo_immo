...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8"
    ...
    <form action="{{ route('properties.update', $property) }}" method="POST" enctype="multipart/form-data">
        ...
        <div x-show="step === 5" x-cloak class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            @php
            $allAmenities = ['wifi' => 'Wi-Fi', 'climatisation' => 'Climatisation', 'parking' => 'Parking', 'piscine' => 'Piscine', 'cuisine' => 'Cuisine équipée', 'television' => 'Télévision', 'machine_a_laver' => 'Machine à laver', 'gardien' => 'Gardien 24h/24', 'ascenseur' => 'Ascenseur', 'generateur' => 'Groupe électrogène', 'eau_chaude' => 'Eau chaude', 'balcon' => 'Balcon/Terrasse', 'refrigerateur' => 'Réfrigérateur', 'four' => 'Four/Micro-ondes'];
            @endphp
